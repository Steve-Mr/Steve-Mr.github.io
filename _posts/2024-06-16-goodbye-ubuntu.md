...
虽然现在已经完成了迁移，但也就只是迁移了。首先还缺少一些软件，比如昨天想起来没有 GIMP，现在也还没装 Steam 或者 Heroic Launcher。还有一些更重要的地方是我现在在用 i3wm——意味着我还在 X11。虽然我也知道 Wayland 现在先进得多，但是要重新处理 Swap/xwayland 以及其他各种潜在兼容问题都让我决定再拖拖，等下次下定决心再来吧。
